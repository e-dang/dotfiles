# Generated by Powerlevel10k configuration wizard on 2020-06-28 at 19:26 PDT.
...
###################################[ my_vcs: git status ]####################################
  ...
  function prompt_my_vcs() {
    ...
    (( VCS_STATUS_NUM_CONFLICTED ))      && p10k segment -f 232 -b ${conflicted} -i "" -t "${VCS_STATUS_NUM_CONFLICTED}"
  }
